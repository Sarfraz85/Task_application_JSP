<%-- 
    Document   : view_user
    Created on : 7 Apr, 2020, 11:40:54 PM
...
var Msg ='<%=request.getAttribute("message")%>';
 ...
 <script type="text/javascript"> window.onload = alertName; </script>
    ...
    <body>
        ...
        <table>
            <thead>
            <td style="font-weight: bold; width: 180px; font-family: Arial black;">Username</td>
            <td style="font-weight: bold; width: 180px; font-family: Arial black;">Password</td>
            <td style="font-weight: bold; width: 180px; font-family: Arial black;">Type</td>
            </thead>
        <%
           ...
           Class.forName("com.mysql.jdbc.Driver");
            ...
            while(rs.next())
            {
                ...
                type=rs.getString("desig");
                out.print("<tr>");
                out.print("<td >"+user+"</td>");
                out.print("<td >"+password+"</td>");
                out.print("<td >"+type+"</td>");
                    out.print("<td ><input type=\"submit\" value=\"deactivate\" formaction=\"deactivate_user\" name=\"id'"+flag+"'\"></td>");
                   out.print("</tr>"); 
                }
                }
            rs.first();
            ...
            while(rs.next())
            {
                ...
                out.print("<td >"+password+"</td>");
                out.print("<td >"+type+"</td>");
                    out.print("<td ><input type=\"submit\" value=\"Activate\" formaction=\"activate_user\" name=\"id'"+flag+"'\"></td>");
                   out.print("</tr>"); 
                }
            }
