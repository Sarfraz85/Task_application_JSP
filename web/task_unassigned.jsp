<%-- 
    Document   : task_unassigned
    Created on : 7 Dec, 2019, 7:10:52 PM
 ...
 <script type="text/javascript"> window.onload = alertName; </script>
    ...
    <body>
        ...
        <div align='left' style="">
            <form name="frm2" action="task_unassigned.jsp" method="post">
        ...
        <%
           ...
           Class.forName("com.mysql.jdbc.Driver");
            ...
            if(client_fil!=null)
            {
                rs=st.executeQuery("select * from tasks where creator = '"+username+"' and status = \"\" and client_id = '"+client_fil+"' ");
                session.setAttribute("filter",client_fil);
            }
            else
            {
                rs=st.executeQuery("select * from tasks where creator = '"+username+"' and status = \"\" ");
            ...
            while(rs.next())
            {
                ...
                out.print("<td width='"+180+"'><input type=\"submit\" value=\"Assign\" formaction=\"task_assign.jsp\" name=\"id'"+flag+"'\"></td>");
                out.print("</tr>");
            }
            %>
            </table>
