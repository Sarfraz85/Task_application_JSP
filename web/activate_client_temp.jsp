<%-- 
    Document   : activate_client_temp
    Created on : 7 Apr, 2020, 11:20:56 PM
    ...
    <body>
        ...
        <%
           ...
           Class.forName("com.mysql.jdbc.Driver");
            ...
            if(client_fil!=null)
            {
                rs=st.executeQuery("select * from temp_client where activation_status = \"inactive\" and id = '"+client_fil+"' ");
            ...
            while(rs.next())
            {
                ...
                out.print("<td >"+pan+"</td>");
                out.print("<td ><input type=\"submit\" value=\"Activate\" formaction=\"activate_client_temporary\" name=\"id'"+flag+"'\"></td>");
                out.print("</tr>");
            }
